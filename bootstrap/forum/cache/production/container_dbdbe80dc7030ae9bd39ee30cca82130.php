...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000ae0f33d0000000044b4c4c1(
...
class phpbbtemplatetwiglexer_000000000ae0f33d0000000044b4c4c1 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5be2e38e4891c151301134 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5be2e38e48927389711193 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5be2e38e488f9694140840 = array(
    ...
    {
        $this->initializer5be2e38e48927389711193 && ($this->initializer5be2e38e48927389711193->__invoke($valueHolder5be2e38e4891c151301134, $this, 'set_environment', array('env' => $env), $this->initializer5be2e38e48927389711193) || 1) && $this->valueHolder5be2e38e4891c151301134 = $valueHolder5be2e38e4891c151301134;

        return $this->valueHolder5be2e38e4891c151301134->set_environment($env);
    }
    ...
    {
        $this->initializer5be2e38e48927389711193 && ($this->initializer5be2e38e48927389711193->__invoke($valueHolder5be2e38e4891c151301134, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5be2e38e48927389711193) || 1) && $this->valueHolder5be2e38e4891c151301134 = $valueHolder5be2e38e4891c151301134;

        return $this->valueHolder5be2e38e4891c151301134->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5be2e38e48927389711193 && ($this->initializer5be2e38e48927389711193->__invoke($valueHolder5be2e38e4891c151301134, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5be2e38e48927389711193) || 1) && $this->valueHolder5be2e38e4891c151301134 = $valueHolder5be2e38e4891c151301134;

        return $this->valueHolder5be2e38e4891c151301134->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5be2e38e48927389711193 = $initializer;
    }
    ...
    {
        $this->initializer5be2e38e48927389711193 && ($this->initializer5be2e38e48927389711193->__invoke($valueHolder5be2e38e4891c151301134, $this, '__get', array('name' => $name), $this->initializer5be2e38e48927389711193) || 1) && $this->valueHolder5be2e38e4891c151301134 = $valueHolder5be2e38e4891c151301134;

        if (isset(self::$publicProperties5be2e38e488f9694140840[$name])) {
            return $this->valueHolder5be2e38e4891c151301134->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5be2e38e4891c151301134;
    ...
    {
        $this->initializer5be2e38e48927389711193 && ($this->initializer5be2e38e48927389711193->__invoke($valueHolder5be2e38e4891c151301134, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5be2e38e48927389711193) || 1) && $this->valueHolder5be2e38e4891c151301134 = $valueHolder5be2e38e4891c151301134;
    ...
    {
        $this->initializer5be2e38e48927389711193 && ($this->initializer5be2e38e48927389711193->__invoke($valueHolder5be2e38e4891c151301134, $this, '__isset', array('name' => $name), $this->initializer5be2e38e48927389711193) || 1) && $this->valueHolder5be2e38e4891c151301134 = $valueHolder5be2e38e4891c151301134;
    ...
    {
        $this->initializer5be2e38e48927389711193 && ($this->initializer5be2e38e48927389711193->__invoke($valueHolder5be2e38e4891c151301134, $this, '__unset', array('name' => $name), $this->initializer5be2e38e48927389711193) || 1) && $this->valueHolder5be2e38e4891c151301134 = $valueHolder5be2e38e4891c151301134;
    ...
    {
        $this->initializer5be2e38e48927389711193 && ($this->initializer5be2e38e48927389711193->__invoke($valueHolder5be2e38e4891c151301134, $this, '__clone', array(), $this->initializer5be2e38e48927389711193) || 1) && $this->valueHolder5be2e38e4891c151301134 = $valueHolder5be2e38e4891c151301134;

        $this->valueHolder5be2e38e4891c151301134 = clone $this->valueHolder5be2e38e4891c151301134;
    }

    public function __sleep()
    {
        $this->initializer5be2e38e48927389711193 && ($this->initializer5be2e38e48927389711193->__invoke($valueHolder5be2e38e4891c151301134, $this, '__sleep', array(), $this->initializer5be2e38e48927389711193) || 1) && $this->valueHolder5be2e38e4891c151301134 = $valueHolder5be2e38e4891c151301134;

        return array('valueHolder5be2e38e4891c151301134');
    }
    ...
    {
        return $this->initializer5be2e38e48927389711193;
    }
    ...
    {
        return $this->initializer5be2e38e48927389711193 && ($this->initializer5be2e38e48927389711193->__invoke($valueHolder5be2e38e4891c151301134, $this, 'initializeProxy', array(), $this->initializer5be2e38e48927389711193) || 1) && $this->valueHolder5be2e38e4891c151301134 = $valueHolder5be2e38e4891c151301134;
    }
    ...
    {
        return null !== $this->valueHolder5be2e38e4891c151301134;
    }
    ...
    {
        return $this->valueHolder5be2e38e4891c151301134;
    }

...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006e7dbe0600000000471495c5(
...
class phpbbtemplatetwiglexer_000000006e7dbe0600000000471495c5 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5be2e39f71b81843327110 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5be2e39f71b89437291056 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5be2e39f71b63218850901 = array(
    ...
    {
        $this->initializer5be2e39f71b89437291056 && ($this->initializer5be2e39f71b89437291056->__invoke($valueHolder5be2e39f71b81843327110, $this, 'set_environment', array('env' => $env), $this->initializer5be2e39f71b89437291056) || 1) && $this->valueHolder5be2e39f71b81843327110 = $valueHolder5be2e39f71b81843327110;

        return $this->valueHolder5be2e39f71b81843327110->set_environment($env);
    }
    ...
    {
        $this->initializer5be2e39f71b89437291056 && ($this->initializer5be2e39f71b89437291056->__invoke($valueHolder5be2e39f71b81843327110, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5be2e39f71b89437291056) || 1) && $this->valueHolder5be2e39f71b81843327110 = $valueHolder5be2e39f71b81843327110;

        return $this->valueHolder5be2e39f71b81843327110->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5be2e39f71b89437291056 && ($this->initializer5be2e39f71b89437291056->__invoke($valueHolder5be2e39f71b81843327110, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5be2e39f71b89437291056) || 1) && $this->valueHolder5be2e39f71b81843327110 = $valueHolder5be2e39f71b81843327110;

        return $this->valueHolder5be2e39f71b81843327110->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5be2e39f71b89437291056 = $initializer;
    }
    ...
    {
        $this->initializer5be2e39f71b89437291056 && ($this->initializer5be2e39f71b89437291056->__invoke($valueHolder5be2e39f71b81843327110, $this, '__get', array('name' => $name), $this->initializer5be2e39f71b89437291056) || 1) && $this->valueHolder5be2e39f71b81843327110 = $valueHolder5be2e39f71b81843327110;

        if (isset(self::$publicProperties5be2e39f71b63218850901[$name])) {
            return $this->valueHolder5be2e39f71b81843327110->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5be2e39f71b81843327110;
    ...
    {
        $this->initializer5be2e39f71b89437291056 && ($this->initializer5be2e39f71b89437291056->__invoke($valueHolder5be2e39f71b81843327110, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5be2e39f71b89437291056) || 1) && $this->valueHolder5be2e39f71b81843327110 = $valueHolder5be2e39f71b81843327110;
    ...
    {
        $this->initializer5be2e39f71b89437291056 && ($this->initializer5be2e39f71b89437291056->__invoke($valueHolder5be2e39f71b81843327110, $this, '__isset', array('name' => $name), $this->initializer5be2e39f71b89437291056) || 1) && $this->valueHolder5be2e39f71b81843327110 = $valueHolder5be2e39f71b81843327110;
    ...
    {
        $this->initializer5be2e39f71b89437291056 && ($this->initializer5be2e39f71b89437291056->__invoke($valueHolder5be2e39f71b81843327110, $this, '__unset', array('name' => $name), $this->initializer5be2e39f71b89437291056) || 1) && $this->valueHolder5be2e39f71b81843327110 = $valueHolder5be2e39f71b81843327110;
    ...
    {
        $this->initializer5be2e39f71b89437291056 && ($this->initializer5be2e39f71b89437291056->__invoke($valueHolder5be2e39f71b81843327110, $this, '__clone', array(), $this->initializer5be2e39f71b89437291056) || 1) && $this->valueHolder5be2e39f71b81843327110 = $valueHolder5be2e39f71b81843327110;

        $this->valueHolder5be2e39f71b81843327110 = clone $this->valueHolder5be2e39f71b81843327110;
    }

    public function __sleep()
    {
        $this->initializer5be2e39f71b89437291056 && ($this->initializer5be2e39f71b89437291056->__invoke($valueHolder5be2e39f71b81843327110, $this, '__sleep', array(), $this->initializer5be2e39f71b89437291056) || 1) && $this->valueHolder5be2e39f71b81843327110 = $valueHolder5be2e39f71b81843327110;

        return array('valueHolder5be2e39f71b81843327110');
    }
    ...
    {
        return $this->initializer5be2e39f71b89437291056;
    }
    ...
    {
        return $this->initializer5be2e39f71b89437291056 && ($this->initializer5be2e39f71b89437291056->__invoke($valueHolder5be2e39f71b81843327110, $this, 'initializeProxy', array(), $this->initializer5be2e39f71b89437291056) || 1) && $this->valueHolder5be2e39f71b81843327110 = $valueHolder5be2e39f71b81843327110;
    }
    ...
    {
        return null !== $this->valueHolder5be2e39f71b81843327110;
    }
    ...
    {
        return $this->valueHolder5be2e39f71b81843327110;
    }
